...
from keras.layers import Dense, Input,Activation,Embedding,Flatten,merge,Merge,SimpleRNN
...
def r_c_nn(train_lexical_data,train_sentence_data,train_label,
    ...
    lexical_branch.add(Bidirectional(SimpleRNN(500,return_sequences=True),merge_mode='concat',
    ...
    sentence_branch.add(Convolution1D(500,3,border_mode='same',input_shape
...
if __name__ == "__main__":
     ...
     r_c_nn(train_lexical_data,train_sentence_data,train_label,
         test_lexical_data,test_sentence_data,test_label)
