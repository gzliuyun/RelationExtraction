...
def store_embedding():
    ...
    np.save("../base_train_embedding_data.npy",train_data)
    np.save("../base_train_embedding_label.npy",train_label)

    test_data,test_label = corpus_embedding(testFilePath,1037)
    np.save("../base_test_embedding_data.npy",test_data)
    np.save("../base_test_embedding_label.npy",test_label)
